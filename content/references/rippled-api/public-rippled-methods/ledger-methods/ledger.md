...
| `ledger.total_coins`           | String  | Total number of RCP drops in the network, as a quoted integer. (This decreases as transaction costs destroy RCP.) |
...
| `fee`               | String           | _(May be omitted)_ The [Transaction Cost](transaction-cost.html) of this transaction, in [drops of RCP][]. |
...
| `max_spend_drops`   | String           | _(May be omitted)_ The maximum amount of [RCP, in drops][], this transaction could potentially send or destroy. |
