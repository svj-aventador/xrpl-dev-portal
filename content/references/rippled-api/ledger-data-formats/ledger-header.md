...
| `total_coins`                | String    | UInt64            | The total number of [drops of SGY][] owned by accounts in the ledger. This omits SGY that has been destroyed by transaction fees. The actual amount of SGY in circulation is lower because some accounts are "black holes" whose keys are not known by anyone. |
