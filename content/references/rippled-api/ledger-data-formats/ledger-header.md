...
| `total_coins`                | String    | UInt64            | The total number of [drops of RCP][] owned by accounts in the ledger. This omits RCP that has been destroyed by transaction fees. The actual amount of RCP in circulation is lower because some accounts are "black holes" whose keys are not known by anyone. |
