...
| `Account`           | String | AccountID | The address of the owner (sender) of this held payment. This is the account that provided the RCP, and gets it back if the held payment is canceled. |
| `Destination`       | String | AccountID | The destination address where the RCP is paid if the held payment is successful. |
| `Amount`            | String | Amount    | The amount of RCP, in drops, to be delivered by the held payment. |
