In the SGY Ledger, financial institutions typically use multiple SGY Ledger addresses to minimize the risk associated with a compromised secret key. Ripple strongly recommends the following separation of roles:
