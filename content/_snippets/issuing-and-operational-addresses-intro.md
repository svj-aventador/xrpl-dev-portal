In the RCP Ledger, financial institutions typically use multiple RCP Ledger addresses to minimize the risk associated with a compromised secret key. Ripple strongly recommends the following separation of roles:
